...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd ~/SawamuraEijun/library/obsidian/Documents/Sawamura<cr>")
--
...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"~/SawamuraEijun/library/obsidian/Documents/Sawamura\"}<cr>")
